// src/types/chef.ts
// Types cho AI Chef feature (Isolated from main app types)
...
export interface ChefResponse {
  ...
  // Enhanced UX Fields
  connection: string; // Director's Commentary
  pairing: string; // Drink/Side dish
  macros: Macros; // Nutrition info
}
