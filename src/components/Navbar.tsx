...
// SỬA LỖI: Đổi tên icon "User" thành "UserIcon" và thêm "Bell", "Heart"
import { 
  Film, 
  Search, 
  User as UserIcon, // <-- SỬA Ở ĐÂY
  Menu, 
  X, 
  LogOut, 
  Heart,
...
// SỬA LỖI: Import kiểu "User" từ AuthContext
              ...
              {!isLoading && (
                <>
                  {user ? (
                    ...
                    // --- CHƯA ĐĂNG NHẬP ---
                    <>
                      <Link to="/browse" className="p-2 text-gray-300 hover:text-cinematic-accent transition-colors" title="Tìm kiếm">
